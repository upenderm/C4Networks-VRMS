...
@XmlType(name = "AgentCustomerDetails", namespace = "http://vo.vrms.c4networks.com/")
@XmlRootElement(name = "AgentCustomerDetails")
public class AgentCustomerDetails implements Serializable {

	private static final long serialVersionUID = 1L;
	private String agCustomerOID;
	...
	private RoleDetail roleId;
	private CompanyDetail companyDetails;
	private String documentID;

	public String getAgCustomerOID() {
		return agCustomerOID;
	}

	public void setAgCustomerOID(String agCustomerOID) {
		this.agCustomerOID = agCustomerOID;
	}
	 ...
	 */
	public void setRoleId(RoleDetail roleId) {
		this.roleId = roleId;
	}

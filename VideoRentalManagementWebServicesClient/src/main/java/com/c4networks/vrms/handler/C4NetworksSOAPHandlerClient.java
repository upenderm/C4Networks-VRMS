...
public class C4NetworksSOAPHandlerClient implements SOAPHandler<SOAPMessageContext> {

	@Override
	public void close(MessageContext msgCtxt) {
		System.out.println("C4NetworksSOAPHandlerClient.close");

	}

	@Override
	public boolean handleFault(SOAPMessageContext context) {
		System.out.println("C4NetworksSOAPHandlerClient.handleFault");
		return false;
	}
